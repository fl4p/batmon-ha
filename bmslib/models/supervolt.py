...
class SuperVoltBt(BtBms):
    ...
    def __init__(self, address, **kwargs):
        ...
        self.totalV = None
        self.soc = None
        self.workingState = 0  # https://github.com/fl4p/batmon-ha/issues/226
        self.alarm = None
        self.chargingA = None
                ...
                if len(data) == 128:
                    ...
                    if type(data) is bytes:
                        ...
                        for i in range(0, 11):
                            ...
                            if self.verbose_log:
                                self.logger.debug(
                                    "volt" + str(i) + ": " + str(bvolt) + " / " + str(self.cellV[i]) + "V")
                        ...
                        if self.verbose_log:
                            self.logger.debug(
                                "discharging: " + str(bdischarging) + " / " + str(self.dischargingA) + "A")
                        ...
                        for i in range(0, 4):
                            ...
                            if self.verbose_log:
                                self.logger.debug(
                                    "temp" + str(i) + ": " + str(btemp) + " / " + str(self.tempC[i]) + "°C")
...
class SuperVoltBt2(SuperVoltBt):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # https://github.com/fl4p/batmon-ha/issues/226#issuecomment-2160130405 :
        self.UUID_RX = '0000ff02-0000-1000-8000-00805f9b34fb'  # std uart TX (tx on device side, rx on host)
        self.UUID_TX = '0000ff01-0000-1000-8000-00805f9b34fb'  # std uart RX
